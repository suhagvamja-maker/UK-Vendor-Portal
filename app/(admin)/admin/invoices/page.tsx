...
const TAB_FILTERS: Record<string, SubmissionStatus[] | null> = {
  active:  ['pending_admin', 'returned_to_admin', 'pending_finance', 'returned_to_vendor', 'approved'],
  paid:    ['paid'],
  rejected:['rejected'],
  all:     null,
};
...
export default async function AdminInvoicesPage({
  ...
  // even on otherwise-terminal statuses like paid.
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        />
        <InvoicesTable rows={rows} linkBase="/admin/submissions" />
      </div>
    </div>
  );
}
